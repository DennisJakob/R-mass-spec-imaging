...
## read data
SDHBp_file_spots <- "20190123_MS37_MetaboliteMix_Spots_60_900_SDHB_pos_A28_100um_89x74"
folder           <- "/msi_datasets"
SDHBp_spots <- readImzML(SDHBp_file_spots, 
                         ...
                         resolution = 0.005,
                         units = "mz")
d <- msimat(rows = "intensity_matrices/MetaMix_SDHBp_m2a_rows.list",
            cols = "intensity_matrices/MetaMix_SDHBp_m2a_cols.list",
            vals = "intensity_matrices/MetaMix_SDHBp_m2a_vals.list",
            peaks = "intensity_matrices/MetaMix_SDHBp_m2a_peaknames.list",
            spots = "intensity_matrices/MetaMix_SDHBp_m2a_spotnames.list")
